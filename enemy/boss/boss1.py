...
class Boss1(pygame.sprite.Sprite):
    ...
    def vLoadImage(self):
        self.imageList = []
        for i in range(2):
            imgName = os.path.abspath("data/image/boss/Boss1Walk_%d.png" % i)
            tmpImage = pygame.image.load(imgName)
            tmpImage = tmpImage.convert_alpha()
            self.imageList.append(tmpImage)
        self.imageListR = []
        for i in range(2):
            imgName = os.path.abspath("data/image/boss/Boss1WalkR_%d.png" % i)
            tmpImage = pygame.image.load(imgName)
            tmpImage = tmpImage.convert_alpha()
            self.imageListR.append(tmpImage)
        self.imageShoot = []
        for i in range(1,5):
            imgName = os.path.abspath("data/image/boss/Boss1Shoot_%d.png" % i)
            tmpImage = pygame.image.load(imgName)
            tmpImage = tmpImage.convert_alpha()
            self.imageShoot.append(tmpImage)
        self.imageShootR = []
        for i in range(1,5):
            imgName = os.path.abspath("data/image/boss/Boss1Shoot_%dR.png" % i)
            tmpImage = pygame.image.load(imgName)
            tmpImage = tmpImage.convert_alpha()
            self.imageShootR.append(tmpImage)
        self.imageDead = []
        for i in range(1,10):
            imgName = os.path.abspath("data/image/boss/Boss1Die_%d.png" % i)
            tmpImage = pygame.image.load(imgName)
            tmpImage = tmpImage.convert_alpha()
